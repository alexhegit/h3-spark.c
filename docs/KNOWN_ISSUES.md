...
| ID | Topic | Status |
|----|-------|--------|
| D | Perf + CUDA `--profile` | **v0.2.1 snapshot** — fox-fast ~15.5 s e2e / ~8.06 s denoise (same md5). Remaining: fox-fast INT8 linear; 15 s long-N SDPA. [`PERF_BASELINE.md`](PERF_BASELINE.md) |
